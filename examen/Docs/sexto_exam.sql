...
INSERT INTO `escuelas` VALUES (1,'Montalvo','Pillaro','EducacionPrimaria'),(2,'San Pio','Ambato','EducacionSecundaria'),(3,'Indoamerica','Ambato','EducacionSecundaria');
...
CREATE TABLE `profesores` (
  ...
  CONSTRAINT `profesores_ibfk_1` FOREIGN KEY (`ID_escuela`) REFERENCES `escuelas` (`ID_escuela`)
...
INSERT INTO `profesores` VALUES (1,1,'asd','asd',123.00),(3,1,'ddddd','sssssss',123.00),(4,2,'Juan Perez','Mate',450.00),(6,1,'asdasd','asdasd',3123213.00),(7,2,'vvv','vv',1231.00),(8,3,'pedro','ciencias',12312.00),(9,2,'Matias','asd',123.00);
...
-- Dump completed on 2023-12-14 17:39:26
